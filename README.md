...
1. [Register](https://github.com/BZngr/VbaDI/edit/main/README.md#register) classes, interfaces, and configuration values with the Container.
2. [Resolve](https://github.com/BZngr/VbaDI/edit/main/README.md#resolve) the application's object graph.  Compose registered classes with their dependencies. 
3. [Release](https://github.com/BZngr/VbaDI/edit/main/README.md#release) the Container and its object references.
...
1. Classes, Interface assignments, and Value dependencies are identified by [RegistrationIDs](https://github.com/BZngr/VbaDI/edit/main/README.md#registrationids).
...
1. Class, Interface and Value dependencies are identified by [RegistrationIDs](https://github.com/BZngr/VbaDI/edit/main/README.md#registrationids).
...
2. RegistrationIDs are used/relevant only during the [Registration](https://github.com/BZngr/VbaDI/edit/main/README.md#register) and [Resolve](https://github.com/BZngr/VbaDI/edit/main/README.md#resolve) phases.
...
6. Recommendation: Do not implement Lifecycle Handlers [^2] for classes registered with the _VbaDI_ container.
    ...
    - Motivation: Creating RegistrationIDs using `TypeName` can result in multiple, often temporary, object instantiations.
        - Lifecycle Handler implementations that 'do too much' can be a source of errors and/or slow performance (see #7 below)
